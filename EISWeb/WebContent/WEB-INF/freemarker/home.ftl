...
<html>
 <head>
  ...
  <script type="text/javascript" src="plugins/tools/curdtools.js"></script>
  <script type="text/javascript" src="plugins/tools/easyuiextend.js"></script>
  <link rel="stylesheet" href="resources/css/base.css" type="text/css"></link>
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
     <td align="left" style="vertical-align:text-bottom" >
      ...
      <!--
      <img src="plugins/login/images/toplogo.png" width="550" height="52" alt="">-->
     </td>
