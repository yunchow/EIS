...
<script src="plugins/jquery/jquery-autocomplete/jquery.autocomplete.js" type="text/javascript"></script>
<link href="plugins/jquery/jquery-autocomplete/jquery.autocomplete.css" rel="stylesheet" type="text/css" /> 
<style>
<!--
	.ac_over{
		background: #E0ECFF;
