...
<%--// 自定义插件 #1
 ...
 <script language="javascript" src="plugins/lodop/LodopFuncs.js"></script>
 <object id="LODOP_OB" classid="clsid:2105C259-1E0C-4534-8141-A753534CB4CA" width=0 height=0>
  <embed id="LODOP_EM" type="application/x-print-lodop" width=0 height=0 pluginspage="plugins/lodop/install_lodop32.exe"></embed>
 </object>
 <script type="text/javascript">
	var LODOP; //声明为全局变量 
