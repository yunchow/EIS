...
<div class="easyui-layout" fit="true">
 <!-- update-begin--Author:TangHong  Date:20130515 for：[91]demo分类菜单中点击表单验证报错 -->
 <link rel="stylesheet" href="plugins/Validform/css/divfrom.css" type="text/css">
 <link rel="stylesheet" href="plugins/Validform/css/style.css" type="text/css">
 <link rel="stylesheet" href="plugins/Validform/css/tablefrom.css" type="text/css">
 <script type="text/javascript" src="plugins/Validform/js/Validform_v5.3.1_min.js"></script>
 <script type="text/javascript" src="plugins/Validform/js/Validform_Datatype.js"></script>
 <script type="text/javascript" src="plugins/Validform/js/datatype.js"></script>
 <!-- update-end--Author:TangHong  Date:20130515 for：[91]demo分类菜单中点击表单验证报错 -->
