...
<script type="text/javascript" src="plugins/Highcharts-2.2.5/js/highcharts.src.js"></script>
<script type="text/javascript" src="plugins/Highcharts-2.2.5/js/modules/exporting.src.js"></script>
