...
ORYX.I18N.PropertyWindow.name = "<span style='color:black'>名称</span>"; // by nick Name
ORYX.I18N.PropertyWindow.value = "<span style='color:black'>值</span>"; // Value
...
ORYX.I18N.PropertyWindow.title = "属性"; // update by nick chow from Properties

if(!ORYX.I18N.ShapeRepository) ORYX.I18N.ShapeRepository = {};
ORYX.I18N.ShapeRepository.title = "图形库"; // update by nick chow from Shape Repository
